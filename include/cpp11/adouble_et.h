...
#define ADOUBLE_UNARY_OPERATORS_LIST OP_UNARY(UnaryMinus, operator-, -)
...
#define OP_CMP(OP_)                                                                                    \
  ...
  inline auto operator OP_(const Expression<Dtype, T>& a, const Expression<Dtype, U>& b)               \
      ->decltype(a.value() OP_ b.value()) {                                                            \
  ...
  class name##Expr : public Expression<Dtype, name##Expr<Dtype, T>> {                \
   private:                                                                          \
    const T& t;                                                                      \
                                                                                     \
   public:                                                                           \
    explicit name##Expr(const Expression<Dtype, T>& a) : t(a.cast()) {               \
    }                                                                                \
...
#define OP_BINARY(NAME, F_, INNER_F_)                                                                               \
  ...
  class NAME##Expr : public Expression<Dtype, NAME##Expr<Dtype, T, U>> {                                            \
   private:                                                                                                         \
    ...
    const U& u;                                                                                                     \
                                                                                                                    \
   public:                                                                                                          \
    explicit NAME##Expr(const Expression<Dtype, T>& a, const Expression<Dtype, U>& b) : t(a.cast()), u(b.cast()) {  \
    }                                                                                                               \
  ...
  class NAME##LeftExpr : public Expression<Dtype, NAME##LeftExpr<Dtype, T>> {                                       \
   private:                                                                                                         \
    ...
    const Dtype u;                                                                                                  \
                                                                                                                    \
   public:                                                                                                          \
    explicit NAME##LeftExpr(const Expression<Dtype, T>& a, const Dtype& b) : t(a.cast()), u(b) {                    \
    }                                                                                                               \
  ...
  class NAME##RightExpr : public Expression<Dtype, NAME##RightExpr<Dtype, U>> {                                     \
   private:                                                                                                         \
    ...
    const U& u;                                                                                                     \
                                                                                                                    \
   public:                                                                                                          \
    explicit NAME##RightExpr(const Dtype& a, const Expression<Dtype, U>& b) : t(a), u(b.cast()) {                   \
    }                                                                                                               \
  ...
  template <typename Dtype, typename T, typename U>                                                                 \
  inline auto F_(const Expression<Dtype, T>& a, const Expression<Dtype, U>& b)                                      \
      ->decltype(NAME##Expr<Dtype, T, U>(a.cast(), b.cast())) {                                                     \
